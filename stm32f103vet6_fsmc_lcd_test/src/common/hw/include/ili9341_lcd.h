...
typedef enum
{
	LCD_ORIENTATION_PORTRAIT 			= 0, // 세로 모드
	LCD_ORIENTATION_LANDSCAPE 			= 1, // 가로 모드
	LCD_ORIENTATION_PORTRAIT_MIRROR 	= 2, // 세로 거울 모드
	LCD_ORIENTATION_LANDSCAPE_MIRROR 	= 3  // 가로 거울 모드
